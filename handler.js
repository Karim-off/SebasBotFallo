  ...
  for (const nk of callUpdate) {
    if (nk.isGroup == false) {
      if (nk.status == 'offer') {
        ...
        const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;𝗝𝗼𝘀𝘁𝗶𝗻👑;;;\nFN:𝙆𝙖𝙧𝙞𝙢👑\nORG:𝙆𝙖𝙧𝙞𝙢👑\nTITLE:\nitem1.TEL;waid=59168683798+591 68683798 387\nitem1.X-ABLabel:𝙆𝙖𝙧𝙞𝙢👑\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:𝙺𝚊𝚛𝚒𝚖👑\nEND:VCARD`;
...
global.dfail = (type, m, conn) => {
  const msg = {
    rowner: '[🌹𝗔𝗗𝗩𝗘𝗥𝗧𝗘𝗡𝗖𝗜𝗔🌹] 𝑬𝑺𝑻𝑬 𝑪𝑶𝑴𝑨𝑵𝑫𝑶 𝑬𝑺 𝑺𝑶𝑳𝑶 𝑷𝑨𝑹𝑨 𝑶𝑾𝑵𝑬𝑹𝑺 𝑶 𝑺𝑻𝑨𝑭𝑭 𝑫𝑬 𝑺𝑬𝑩𝑨𝑺 𝑩𝑶𝑻',
    owner: '[🌹𝗔𝗗𝗩𝗘𝗥𝗧𝗘𝗡𝗖𝗜𝗔🌹] 𝑬𝑺𝑻𝑬 𝑪𝑶𝑴𝑨𝑵𝑫𝑶 𝑬𝑺 𝑺𝑶𝑳𝑶 𝑷𝑨𝑹𝑨 𝑶𝑾𝑵𝑬𝑹𝑺 𝑶 𝑺𝑻𝑨𝑭𝑭 𝑫𝑬 𝑺𝑬𝑩𝑨𝑺 𝑩𝑶𝑻',
    mods: '[🌹𝗔𝗗𝗩𝗘𝗥𝗧𝗘𝗡𝗖𝗜𝗔🌹] 𝑬𝑺𝑻𝑬 𝑪𝑶𝑴𝑨𝑵𝑫𝑶 𝑬𝑺 𝑺𝑶𝑳𝑶 𝑷𝑨𝑹𝑨 𝑶𝑾𝑴𝑬𝑹𝑺 𝑶 𝑺𝑻𝑨𝑭𝑭 𝑫𝑬 𝑺𝑬𝑩𝑨𝑺 𝑩𝑶𝑻',
    premium: '[🌹𝗔𝗗𝗩𝗘𝗥𝗧𝗘𝗡𝗖𝗜𝗔🌹] 𝑬𝑺𝑻𝑬 𝑪𝑶𝑴𝑨𝑵𝑫𝑶 𝑬𝑺 𝑷𝑨𝑹𝑨 𝑶𝑾𝑵𝑬𝑹𝑺,𝑺𝑻𝑨𝑭𝑭 𝒀 𝑼𝑺𝑼𝑨𝑹𝑰𝑶𝑺 𝑽𝑰𝑷 𝑫𝑬 𝑺𝑬𝑩𝑨𝑺 𝑩𝑶𝑻',
    ...
    restrict: '[🌹𝗔𝗗𝗩𝗘𝗥𝗧𝗘𝗡𝗖𝗜𝗔🌹] 𝑬𝑳 𝑪𝑶𝑴𝑨𝑵𝑫𝑶 𝑬𝑺𝑻𝑨 𝑹𝑬𝑺𝑻𝑹𝑰𝑵𝑮𝑰𝑫𝑶 𝑷𝑶𝑹 𝑳𝑶𝑺 𝑶𝑾𝑵𝑬𝑹𝑺 𝒀 𝑺𝑻𝑨𝑭𝑭 𝑫𝑬 𝑺𝑬𝑩𝑨𝑺 𝑩𝑶𝑻',
  }[type];
  const aa = {quoted: m, userJid: conn.user.jid};
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '🛑 ❱❱ *𝙸𝙽𝙵𝙾𝚁𝙼𝙰𝚃𝙸𝚅𝙾* ❰❰ 🛑', body: ' 𝑺𝑬𝑩𝑨𝑺 𝑩𝑶𝑻', thumbnail: imagen1, sourceUrl: https://www.instagram.com/usxr_angelito/}}}}, aa);
