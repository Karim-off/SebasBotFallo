...
┣☆🖇️.𝘁𝗿𝘂𝗲 𝗮𝗻𝘁𝗶𝗹𝗶𝗻𝗸:(ᴀᴅᴍɪsɴ)
┣☆🖇️.𝗳𝗮𝗹𝘀𝗲 𝗮𝗻𝘁𝗶𝗹𝗶𝗻𝗸:(ᴀᴅᴍɪɴs)
┣☆📎.𝘁𝗿𝘂𝗲 𝗮𝗻𝘁𝗶𝗹𝗶𝗻𝗸2:(ᴀᴅᴍɪɴs)
┣☆📎.𝗳𝗮𝗹𝘀𝗲 𝗮𝗻𝘁𝗶𝗹𝗶𝗻𝗸2:(ᴀᴅᴍɪɴs)
┣☆🖋️.𝘁𝗿𝘂𝗲 𝗱𝗲𝘁𝗲𝗰𝘁:(ᴀᴅᴍɪɴs)
┣☆🖋️.𝗳𝗮𝗹𝘀𝗲 𝗱𝗲𝘁𝗲𝗰𝘁:(ᴀᴅᴍɪɴs)
┣☆🖊️.𝘁𝗿𝘂𝗲 𝗱𝗲𝗰𝘁𝗲𝗰𝘁2:(ᴀᴅᴍɪɴs)
┣☆🖊️.𝗳𝗮𝗹𝘀𝗲 𝗱𝗲𝘁𝗲𝗰𝘁2:(ᴀᴅᴍɪɴs)
┣☆🛡️.𝘁𝗿𝘂𝗲 𝗿𝗲𝘀𝘁𝗿𝗶𝗰𝘁:(ᴏᴡɴᴇʀs)
┣☆🛡️.𝗳𝗮𝗹𝘀𝗲 𝗿𝗲𝘀𝘁𝗿𝗶𝗰𝘁:(ᴏᴡɴᴇʀs)
┣☆👤.𝘁𝗿𝘂𝗲 𝗽𝗰𝗼𝗻𝗹𝘆:(ᴏᴡɴᴇʀs
┣☆👤.𝗳𝗮𝗹𝘀𝗲 𝗽𝗰𝗼𝗻𝗹𝘆:(ᴏᴡɴᴇʀs)
┣☆👥.𝘁𝗿𝘂𝗲 𝗴𝗰𝗼𝗻𝗹𝘆:(ᴏᴡɴᴇʀs
┣☆👥.𝗳𝗮𝗹𝘀𝗲 𝗴𝗰𝗼𝗻𝗹𝘆:(ᴏᴡɴᴇʀs)
...
┣☆☢️.𝘁𝗿𝘂𝗲 𝗮𝗻𝘁𝗶𝘁𝗼𝘅𝗶𝗰:(ᴀᴅᴍɪɴs)
┣☆☢️.𝗳𝗮𝗹𝘀𝗲 𝗮𝗻𝘁𝗶𝘁𝗼𝘅𝗶𝗰:(ᴀᴅᴍɪɴs)
...
┣☆⚙️.𝘁𝗿𝘂𝗲 𝗮𝘂𝗱𝗶𝗼𝘀_𝗯𝗼𝘁:(ᴏᴡɴᴇʀs)
┣☆⚙️.𝗳𝗮𝗹𝘀𝗲 𝗮𝘂𝗱𝗶𝗼𝘀_𝗯𝗼𝘁:(ᴏᴡɴᴇʀs)
┣ ☆> (𝑺𝑬𝑩𝑨𝑺 𝑩𝑶𝑻) <☆
┗━━━━━━━━━━━━━━━━━━┛`.trim();
  ...
  conn.sendMessage(m.chat, {text: `       ☆𝑺𝑬𝑩𝑨𝑺 𝑩𝑶𝑻☆\n[💖] 𝗢𝗣𝗖𝗜𝗢̃𝗡: ${type}✔️\n[🌟] 𝐄𝐒𝐓𝐀𝐃𝐎: ${isEnable ? '𝑶𝒏✔️' : '𝑶𝒇𝒇✔️'}\n[🧸] 𝐏𝐀𝐑𝐀: ${isAll ? '𝑺𝑬𝑩𝑨𝑺 𝑩𝑶𝑻✔️' : isUser ? '' : '𝑬𝒔𝒕𝒆 𝒄𝒉𝒂𝒕✔️'}`}, {quoted: m});
};
handler.help = ['en', 'dis'].map((v) => v + 'able <option>');
handler.tags = ['group', 'owner'];
handler.command = /^((true|false|enable)|(tru|fals)e|(turn)?[01])$/i;
